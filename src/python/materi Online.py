# my_list = []
# my_list.append(12) -> menambahkan bilangan 12 ke array my_list
# my_list.extend([1,2,3,4]) -> mengabungkan array [1,2,3,4,5] dengan array my_list
# my_list.remove(2) -> menghapus indeks tertentu
# array = []
# array += [valueToBeInserted]
# mylist = ["a", "b", "a", "c", "c"]
# mylist = list(dict.fromkeys(mylist)) -> menghapus duplikat di array
# print(mylist)
# digit.sort()-> mengurutkan secara ascending
# digitbaru = digit.sort(reverse=True)
# for x in "banana":
#   print(x)
...
# for word in s.split ():
# print(word)
# dig = len(str(input())) menghitung jumlah digit
